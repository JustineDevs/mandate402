...
description: Load when applying core engineering principles such as SOLID, OOP, encapsulation, abstraction, DRY, KISS, YAGNI, composition, or dependency design.

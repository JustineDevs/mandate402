...
description: Load when implementing complex TypeScript types, generics, conditional types, mapped types, template literals, utility types, or compile-time safety.
---

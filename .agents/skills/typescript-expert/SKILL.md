...
description: Load when solving advanced TypeScript or JavaScript issues involving type-level programming, performance, migrations, tooling, or complex diagnostics.
metadata:
  category: framework
  risk: critical
  source: community

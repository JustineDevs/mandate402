...
function scanFile(relPath) {
  ...
  const checks = [
    ...
    },
    {
      ...
      regex:
        /^(MANDATE402_DATABASE_URL|MANDATE402_DATABASE_DIRECT_URL|DATABASE_URL|DATABASE_DIRECT_URL)=(?!postgres:\/\/user:password@host:5432\/mandate402\b)(?!postgres:\/\/mandate402:mandate402@127\.0\.0\.1:5432\/mandate402_test\b)(?!postgresql:\/\/postgres\.ivntudcibtwnonpwstjh:\[YOUR-PASSWORD\]@aws-1-ap-southeast-1\.pooler\.supabase\.com:6543\/postgres\b)(?!postgresql:\/\/postgres:\[YOUR-PASSWORD\]@db\.ivntudcibtwnonpwstjh\.supabase\.co:5432\/postgres\b)(?!replace-me\b).+@.+/m,
    },
    {

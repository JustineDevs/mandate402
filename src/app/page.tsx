          ...
          >
            ...
            >
              <div className="flex w-full max-w-xl flex-col items-center gap-5 sm:max-w-2xl sm:gap-6">
                <p className="w-full shrink-0 text-center font-mono-reference text-[11px] font-semibold uppercase tracking-[0.14em] text-steel sm:text-xs">
                  Operator Access
                </p>
                ...
                <div className="w-full max-w-lg border border-hairline bg-surface-soft sm:max-w-xl">
                  ...
                  <div className="divide-y divide-hairline">
                    <div className="px-4 py-3.5 text-center sm:px-6 sm:py-4">
                      <p className="font-mono-reference text-sm text-slate sm:text-base">
                        Email / Operator ID
                      </p>
                    </div>
                    <div className="px-4 py-3.5 text-center sm:px-6 sm:py-4">
                      ...
                      <p className="mt-2 text-sm leading-relaxed text-steel sm:text-base">
                        Wallet and session actions run inside the operator
                        workspace — not on this page.
                      </p>
                    </div>
                    <div className="px-4 py-2 text-center sm:px-6">
                      <p className="text-xs leading-relaxed text-steel sm:text-sm">
                        ...
                        to choose email / operator ID or wallet session before
              ...
              <div className="flex w-full max-w-xl flex-col items-start gap-4 text-left sm:gap-5 lg:max-w-lg">
                <div className="flex min-w-0 flex-wrap items-center justify-start gap-2.5 sm:gap-3">
                  <Image
                    ...
                    priority
                  />
                  <span className="min-w-0 font-mono-reference text-base font-bold tracking-tight text-ink sm:text-lg lg:text-xl">
                    Mandate402
                  </span>
                </div>
                ...
                <div className="w-full min-w-0">
                  ...
                  <div className="mt-3 flex flex-wrap items-center justify-start gap-4 sm:mt-4 sm:gap-5 lg:gap-6">
                    ...
                    >
                      <Image
                        src="/images/Lime-Black%20Primary%20Horizontal%20Lockup.png"
                        alt="Morph"
                        width={180}
                        height={48}

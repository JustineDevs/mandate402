 ...
 */
const GaugeTrack: React.FC<GaugeTrackProps> = ({ id, agentName, spend, max, onAgentClick }) => {
    ...
    <div className="space-y-2">
      <div className="flex justify-between items-center">
        <div className="relative group">
          ...
          >
            {agentName} <span className="text-[10px] opacity-50" aria-hidden="true">v</span>
          </button>
        </div>
        <span className="text-[#1F2937] font-bold">${spend}</span>
      </div>
      <div className="h-2 w-full bg-[#E4ECE9] rounded-full overflow-hidden" aria-hidden="true">
        <div 

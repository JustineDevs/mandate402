...
export const KpiCard: React.FC<KpiCardProps> = ({
  ...
  return (
    <div
      className="bg-white p-6 border border-[#E4ECE9] border-dashed rounded-lg shadow-sm"
    ...
    >
      ...
      <div className="flex items-baseline gap-3 mb-1">
        ...
        <span
          className={`text-sm font-bold flex items-center ${isPositive ? "text-[#22C55E]" : "text-[#EF4444]"}`}
        >
          {delta}%{" "}
          <span className="text-[10px] ml-1">{isPositive ? "▲" : "▼"}</span>
        </span>
      </div>
